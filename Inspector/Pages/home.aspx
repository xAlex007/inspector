...
<asp:Content ID="Body" ContentPlaceHolderID="render" runat="Server">
    <div id="l-gradient">
        <div class="container">
            <!--Relógio-->
            <div class="row text-center mb-lg-4" style="font-size: calc(1rem + 2.5vw);">
                ...
                <div class="col-9 col-sm-8 col-lg-5 col-xl-4 menu-border" style="border-color: #4ED84B; background-color: rgba(255,255,255,0.5);">
                    <div class="row g-5 row-cols-2 py-5">
                        <div class="col d-flex justify-content-end">
                            <asp:HyperLink class="item-inspecao p-2" NavigateUrl="~/Pages/inspecao.aspx" ToolTip="Registrar Inspeções" runat="server"><asp:Image ImageUrl="~/Src/img/caliper.png" AlternateText="Registrar Inspeções" ToolTip="Registrar Inspeções" style="height: 90px;" runat="server" /></asp:HyperLink>
                        </div>
